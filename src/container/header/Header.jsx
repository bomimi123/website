  ...
  return (
        <div className="gpt3__header section__padding" id="home">
          <div className="gpt3__header-content">
            <h1 className="gradien__text">Let’s Build Somethingamazing with GPT-3OpenAI</h1>
            ...
            <div className="gpt3__header-content__people" id="people">
              <img src={people} alt="people"/>
              <p className="text">1,600 people requested access a visit in last 24 hours</p>
            </div>
